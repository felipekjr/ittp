...
void pesquisarValor()
{
    ...
    else
    {
        ...
        while (option != 0)
        {
            ...
            {
            case 1:
                pesquisarMaiores(tabela, valor, coluna_escolhida);
                break;
            case 2:
                pesquisarMaioresIguais(tabela, valor, coluna_escolhida);
                break;
            case 3:
                pesquisarIguais(tabela, valor, coluna_escolhida);
                break;
            case 4:
                pesquisarMenores(tabela, valor, coluna_escolhida);
                break;
            case 5:
                pesquisarMenoresIguais(tabela, valor, coluna_escolhida);
                break;
            case 6:
                pesquisarProximos(tabela, valor, coluna_escolhida);
                break;
            default:
                break;
            }
